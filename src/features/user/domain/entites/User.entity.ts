...
import { OtpCodes } from "../../../auth/domain/entites/otp-code.entity"
...
import { CoursesPurchased } from "../../../courses/domain/entites/course-purchased.entity" 
...
export class User extends BaseEntity {
    ...
    Otpcode: OtpCodes[]
    @OneToMany(() => CoursesPurchased, (purchased: any) => purchased.user)
