...
let BookCategoryEntity = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)("BookCategories")];
    ...
    var BookCategoryEntity = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.title = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _title_initializers, void 0));
            this.books = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _books_initializers, void 0));
            __runInitializers(this, _books_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "BookCategoryEntity");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _title_decorators = [(0, typeorm_1.Column)({ type: "varchar", length: 64, unique: true })];
        _books_decorators = [(0, typeorm_1.OneToMany)(() => book_entity_1.BookEntity, book => book.category)];
        ...
        BookCategoryEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BookCategoryEntity = _classThis;
})();
