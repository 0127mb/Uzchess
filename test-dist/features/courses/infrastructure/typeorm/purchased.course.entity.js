...
let PurchasedCourses = (() => {
    ...
    var PurchasedCourses = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.isCompleted = (__runInitializers(this, _course_extraInitializers), __runInitializers(this, _isCompleted_initializers, void 0));
            this.date = (__runInitializers(this, _isCompleted_extraInitializers), __runInitializers(this, _date_initializers, void 0));
            __runInitializers(this, _date_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "PurchasedCourses");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => User_entity_1.User, user => user.purchasedcourses)];
        _course_decorators = [(0, typeorm_1.ManyToOne)(() => Course_entity_1.CourseEntity, course => course.purchasedcourses)];
        ...
        PurchasedCourses = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PurchasedCourses = _classThis;
})();
