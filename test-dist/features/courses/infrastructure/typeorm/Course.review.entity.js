...
let CourseReviews = (() => {
    ...
    var CourseReviews = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.rating = (__runInitializers(this, _course_extraInitializers), __runInitializers(this, _rating_initializers, void 0));
    ...
    __setFunctionName(_classThis, "CourseReviews");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => User_entity_1.User, user => user.reviews)];
        _course_decorators = [(0, typeorm_1.ManyToOne)(() => Course_entity_1.CourseEntity, course => course.reviews)];
        ...
        CourseReviews = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CourseReviews = _classThis;
})();
exports.CourseReviews = CourseReviews;
