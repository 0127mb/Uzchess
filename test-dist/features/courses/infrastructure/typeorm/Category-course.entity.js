...
exports.CategoryCourse = void 0;
const typeorm_1 = require("typeorm");
const Course_entity_1 = require("./Course.entity");
let CategoryCourse = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)("CategoryCourse")];
    ...
    var CategoryCourse = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.title = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _title_initializers, void 0));
            this.course = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _course_initializers, void 0));
            __runInitializers(this, _course_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "CategoryCourse");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _title_decorators = [(0, typeorm_1.Column)({ type: "varchar", length: 128 })];
        _course_decorators = [(0, typeorm_1.OneToMany)(() => Course_entity_1.CourseEntity, course => course.category)];
        ...
        CategoryCourse = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CategoryCourse = _classThis;
})();
exports.CategoryCourse = CategoryCourse;
