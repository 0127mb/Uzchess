...
let UpdateCourseDto = (() => {
    ...
    return _a = class UpdateCourseDto {
            constructor() {
                ...
                __runInitializers(this, _difficultyId_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _title_decorators = [(0, swagger_1.ApiProperty)({ example: "JavaScript Advanced Updated", description: "Course title", required: false }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _price_decorators = [(0, swagger_1.ApiProperty)({ example: 89.99, description: "Updated course price", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _newPrice_decorators = [(0, swagger_1.ApiProperty)({ example: 69.99, description: "Updated discounted price", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _authorId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Author ID", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _categoryId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Category ID", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _languageId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Language ID", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _difficultyId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Difficulty ID", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
