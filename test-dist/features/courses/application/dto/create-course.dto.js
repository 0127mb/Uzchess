...
let CreateCourseDto = (() => {
    ...
    return _a = class CreateCourseDto {
            constructor() {
                this.authorId = __runInitializers(this, _authorId_initializers, void 0);
                ...
                this.title = (__runInitializers(this, _difficultyId_extraInitializers), __runInitializers(this, _title_initializers, void 0));
                ...
                __runInitializers(this, _newPrice_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _authorId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Author ID" }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _categoryId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Category ID" }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _languageId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Language ID" }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _difficultyId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Difficulty ID" }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _title_decorators = [(0, swagger_1.ApiProperty)({ example: "JavaScript Advanced", description: "Course title" }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _price_decorators = [(0, swagger_1.ApiProperty)({ example: 99.99, description: "Course price" }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _newPrice_decorators = [(0, swagger_1.ApiProperty)({ example: 79.99, description: "Discounted price", required: false }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
